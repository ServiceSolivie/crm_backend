...
<body style="font-family: Arial, sans-serif; color: #1f2937; margin: 0; padding: 24px; background: #f9fafb;">
    <div style="max-width: 560px; margin: 0 auto; background: #ffffff; border-radius: 8px; padding: 32px;">
        <h2 style="margin-top: 0;">Lead à corriger</h2>
        <p>Le lead <strong>{{ $leadName }}</strong> ({{ $lead->reference }}) a été renvoyé par la gestion et nécessite votre intervention avant de pouvoir continuer le traitement.</p>

        <p style="margin-bottom: 4px;"><strong>Points signalés :</strong></p>
