...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | These map raw field names (as used in this app's Form Request rules())
    | to natural French labels, so messages read as "Le champ Agent est
    | obligatoire." instead of "Le champ agent_id est obligatoire."
    |
    */
    ...
    'attributes' => [
        ...
        'comment' => 'commentaire',
        'company_annual_revenue' => 'chiffre d\'affaires annuel',
        'company_employee_count' => 'nombre d\'employés',
        'company_legal_form' => 'forme juridique',
        'company_name' => 'nom de l\'entreprise',
        'company_sector' => 'secteur d\'activité',
        'company_status' => 'statut de l\'entreprise',
        'current_password' => 'mot de passe actuel',
        'custom_payment_method' => 'méthode de paiement personnalisée',
        'device_name' => 'nom de l\'appareil',
        'document_type' => 'type de document',
        'document_type_ids' => 'types de document',
        'document_type_ids.*' => 'type de document',
        'email' => 'adresse email',
